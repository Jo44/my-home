...
function assembleHtml(page) {
    ...
    url = path + '/youtube_playlists?action=update&idPlaylist=' + playlistId
	    + '&order-by=artist&dir=asc';
	...
	td = document.createElement('td');
	a = document.createElement('a');
	url = path + '/youtube_videos?action=update&idPlaylist='
		+ videos[i].playlistId + '&idVideo=' + videos[i].id
		+ '&order-by=date&dir=desc';
	a.setAttribute('href', url);
	a
		.setAttribute('class',
	...
	a = document.createElement('a');
	value = path + '/youtube_videos?action=delete&idPlaylist='
		+ videos[i].playlistId + '&idVideo=' + videos[i].id;
