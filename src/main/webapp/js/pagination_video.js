...
function assembleHtml(page) {
    ...
    span.innerText = 'Artiste';
    th.appendChild(span);
    div = document.createElement('div');
    div.setAttribute('class','in-line');
    a = document.createElement('a');
    url = path + '/youtube_playlists?action=update&idPlaylist=' + playlistId + '&order-by=artist&dir=asc';
    a.setAttribute('href',url);
    a.setAttribute('class','fa fa-fw fa-angle-up order-arrow small-marged in-block');
    div.appendChild(a);
    a = document.createElement('a');
    url = path + '/youtube_playlists?action=update&idPlaylist=' + playlistId + '&order-by=artist&dir=desc';
    a.setAttribute('href',url);
    ...
    div.setAttribute('class','in-line');
    a = document.createElement('a');
    url = path + '/youtube_playlists?action=update&idPlaylist=' + playlistId + '&order-by=title&dir=asc';
    a.setAttribute('href',url);
    a.setAttribute('class','fa fa-fw fa-angle-up order-arrow small-marged in-block');
    div.appendChild(a);
    a = document.createElement('a');
    url = path + '/youtube_playlists?action=update&idPlaylist=' + playlistId + '&order-by=title&dir=desc';
    a.setAttribute('href',url);
    a.setAttribute('class','fa fa-fw fa-angle-down order-arrow small-marged in-block');
    div.appendChild(a);
    th.appendChild(div);
    ...
    span = document.createElement('span');
    span.setAttribute('class','title-order-bottom');
    span.innerText = 'Durée';
    th.appendChild(span);
    div = document.createElement('div');
    div.setAttribute('class','in-line');
    a = document.createElement('a');
    url = path + '/youtube_playlists?action=update&idPlaylist=' + playlistId + '&order-by=duration&dir=asc';
    a.setAttribute('href',url);
    a.setAttribute('class','fa fa-fw fa-angle-up order-arrow small-marged in-block');
    div.appendChild(a);
    a = document.createElement('a');
    url = path + '/youtube_playlists?action=update&idPlaylist=' + playlistId + '&order-by=duration&dir=desc';
    a.setAttribute('href',url);
    a.setAttribute('class','fa fa-fw fa-angle-down order-arrow small-marged in-block');
    div.appendChild(a);
    th.appendChild(div);
    ...
    div.setAttribute('class','in-line');
    a = document.createElement('a');
    url = path + '/youtube_playlists?action=update&idPlaylist=' + playlistId + '&order-by=date&dir=asc';
    a.setAttribute('href',url);
    a.setAttribute('class','fa fa-fw fa-angle-up order-arrow small-marged in-block');
    div.appendChild(a);
    a = document.createElement('a');
    url = path + '/youtube_playlists?action=update&idPlaylist=' + playlistId + '&order-by=date&dir=desc';
    a.setAttribute('href',url);
    a.setAttribute('class','fa fa-fw fa-angle-down order-arrow small-marged in-block');
    div.appendChild(a);
    th.appendChild(div);
    ...
    && i < videos.length; i++) {
        ...
        if (videos[i].artist.length < 30) {
            td.innerText = videos[i].artist;
        } else {
            td.innerText = videos[i].artist.substring(0, 29);
        }
        tr.appendChild(td);
        // Td Title
        td = document.createElement('td');
        if (videos[i].title.length < 20) {
            td.innerText = videos[i].title;
        } else {
            td.innerText = videos[i].title.substring(0, 19);
        }
        tr.appendChild(td);
        // Td Duration
        td = document.createElement('td');
        td.innerText = videos[i].duration;
        tr.appendChild(td);
        // Td Date
        td = document.createElement('td');
        td.innerText = videos[i].saveDate;
        tr.appendChild(td);
        // Td Action
        td = document.createElement('td');
        a = document.createElement('a');
        url = path + '/youtube_videos?action=update&idPlaylist=' + videos[i].playlistId + '&idVideo=' + videos[i].id + '&order-by=date&dir=desc';
        a.setAttribute('href',url);
        ...
        value = '.modal-confirm-' + videos[i].id;
        ...
        div = document.createElement('div');
        value = 'modal fade modal-confirm-' + videos[i].id;
        ...
        p.innerText = 'Voulez-vous confirmer la suppression de cette vidéo ?';
        div4.appendChild(p);
        div3.appendChild(div4);
        div4 = document.createElement('div');
        div4.setAttribute('class','modal-footer center');
        a = document.createElement('a');
        value = path + '/youtube_videos?action=delete&idPlaylist=' + videos[i].playlistId + '&idVideo=' + videos[i].id;
...
function numPages() {
    return Math.ceil(videos.length / records_per_page);
}
