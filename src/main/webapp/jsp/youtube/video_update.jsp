...
<%
    ...
    YouTubeVideo video = (YouTubeVideo) view.getValueForKey("video");
							...
							<div class="panel-body">
								...
								<div class="col-xs-12 marged-top">
									<label for="textRawUrlVideo">URL de la vidéo</label> <br> <input class="col-xs-offset-1 col-xs-10" id="textRawUrlVideo"
										name="rawUrlVideo" type="text" pattern=".{1,50}" value="https://www.youtube.com/watch?v=<%=video.getIdUrl()%>"
										title="Entre 1 et 50 caractères" placeholder="ex: https://www.youtube.com/watch?v=8AF-Sm8d8yk">
								</div>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-offset-1 col-md-10 col-md-offset-1 col-lg-offset-1 col-lg-10 col-lg-offset-1">
						<div class="panel panel-default center-div">
							...
							<div class="panel-body">
								<form id="updateVideoForm" action="youtube_videos" method="post">
									...
									<div class="col-xs-12 col-sm-offset-1 col-sm-5 marged-top">
										<label for="textArtist">Artiste</label>
										<br>
										<input class="col-xs-offset-2 col-xs-8 col-sm-offset-1 col-sm-10" id="textArtist" name="artistVideo"
											type="text" pattern=".{1,50}" title="Entre 1 et 50 caractères" value="<%=video.getArtist()%>"
											placeholder="ex: Bigflo & Oli" required>
									</div>
									<div class="col-xs-12 col-sm-5 marged-top">
										<label for="textTitle">Titre</label>
										<br>
										<input class="col-xs-offset-2 col-xs-8 col-sm-offset-1 col-sm-10" id="textTitle" name="titleVideo"
											type="text" pattern=".{1,50}" title="Entre 1 et 50 caractères" value="<%=video.getTitle()%>"
											placeholder="ex: Dommage" required>
									</div>
									<div class="col-xs-12 col-sm-offset-1 col-sm-5 marged-top">
										<label for="textUrlVideo">ID YouTube</label>
										<br>
										<input class="col-xs-offset-2 col-xs-8 col-sm-offset-2 col-sm-8" id="textUrlVideo" name="urlVideo"
											type="text" pattern=".{11}" title="11 caractères" value="<%=video.getIdUrl()%>"
											placeholder="ex: 8AF-Sm8d8yk" required>
									</div>
									<div class="col-xs-12 col-sm-5 marged-top">
										<label for="textDuration">Durée</label>
										<br>
										<input class="col-xs-offset-4 col-xs-4 col-sm-offset-3 col-sm-6" id="textDuration" name="durationVideo"
											type="text" pattern="[0-9]{0,3}[:]{0,1}[0-9]{1,2}[:]{1}[0-9]{2}" value="<%=video.getDuration()%>"
