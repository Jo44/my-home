...
/**
 * Classe DatabaseAccess permettant d'établir une session Hibernate, de gérer les transactions et de tester la connexion
 * 
 * @author Jonathan
 * @version 1.0
 * @since 23/04/2018
...
public class DatabaseAccess {
	...
	private Session openSessionRetry(int nbTentative, Session session) throws TechnicalException {
		if (nbTentative < 3) {
			...
			GlobalTools.sendEmail(EMAIL_TARGET, "", EMAIL_FAIL);
